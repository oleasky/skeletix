...
const StatCard = ({ statData = {
    ...
    return (react_1.default.createElement("article", { className: `flex-1 flex flex-col text-center py-fluid-xl px-fluid-xl bg-slate-50 ${compId} ${className}` },
        ...
        react_1.default.createElement("div", { className: `z-10 ${compId}__content` },
